...
export const UemkResponse = {
  titleKurs: 'Разработка на JAVA',
  descriptionKurs:
    'Данный учебный курс посвящен фундаментальным концепциям и методам разработки приложений на языке Java. Курс направлен на изучение ключевых аспектов языка, включая объектно-ориентированное программирование, работу с коллекциями, потоками ввода-вывода, многопоточностью и управлением памятью.В ходе занятий студенты изучат основы Java, включая синтаксис, управление исключениями и использование стандартной библиотеки. Особое внимание уделено работе с многопоточностью, включая создание и управление потоками, использование классов из пакета java.util.concurrent и механизмов синхронизации. Также рассматриваются аспекты работы с базами данных с использованием JDBC и основные подходы к разработке современных приложений, такие как работа с REST API и внедрение зависимостей (Dependency Injection). Студенты научатся применять полученные знания на практике, разрабатывая консольные и веб-приложения, обрабатывающие большие объемы данных и поддерживающие параллельное выполнение задач. Курс включает практические задания и проекты, направленные на решение реальных задач, что поможет освоить навыки создания надежного и производительного кода для корпоративных и пользовательских приложений.',
